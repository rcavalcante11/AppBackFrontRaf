...
//  AppBackFront
//
//  Created by macbook on 01/07/2025.
//
...
protocol LoginScreenProtocol: AnyObject {
    ...
    lazy var passwordTextField: UITextField = {
        ...
        tf.attributedPlaceholder = NSAttributedString(string: "Password", attributes: [NSAttributedString.Key.foregroundColor: UIColor.white.withAlphaComponent(0.4)])
        tf.textColor = .white
        tf.clipsToBounds = true
        tf.layer.cornerRadius = 12
        tf.layer.borderWidth = 1.0
    ...
    private func configConstraints(){
        NSLayoutConstraint.activate([
            ...
            lineview.leadingAnchor.constraint(equalTo: subLoginImageView.leadingAnchor,constant: 64),
            lineview.trailingAnchor.constraint(equalTo: subLoginImageView.trailingAnchor,constant: -64),
